...
public class AdminServiceImpl implements AdminService {
    ...
    public List<AdminUserDto> getAllAdmins() {
        // Retrieve all Admin entities from repository
        List<Admin> admins = adminRepo.findAll();

        // Retrieve all UserDtos from adminUserService
        List<UserDto> userDtos = adminUserService.getAllUsers();

        // Convert Admin entities to AdminDtos
        List<AdminDto> adminDtos = adminMapper.toAdminDtoList(admins);

        // Combine AdminDtos and UserDtos to create a list of AdminUserDtos
        return adminMapper.toAdminUserDtoList(adminDtos, userDtos);
    }
